/*
 * Archivo de DATOS con los 118 elementos químicos + 2 placeholders.
 * La clave 'category' se usa en diseño.css para asignar el color.
 * La clave 'config' ahora usa la notación expandida completa.
*/
const elementsData = [
    // Periodo 1
    {
        number: 1, symbol: "H", name: "Hidrógeno", mass: 1.008, row: 1, column: 1,
        category: "hydrogen", type: "No metal", state: "Gas", config: "1s¹",
    ...
    },
    {
        ...
        category: "gas-noble", type: "Gas Noble", state: "Gas", config: "1s²",
    ...
    // Periodo 2
    {
        ...
        category: "alcalino", type: "Metal Alcalino", state: "Sólido", config: "1s² 2s¹",
    ...
    },
    {
        ...
        category: "alcalinoterreo", type: "Metal Alcalinotérreo", state: "Sólido", config: "1s² 2s²",
    ...
    },
    {
        ...
        category: "metaloide", type: "Metaloide", state: "Sólido", config: "1s² 2s² 2p¹",
    ...
    },
    {
        ...
        category: "no-metal", type: "No metal", state: "Sólido", config: "1s² 2s² 2p²",
    ...
    },
    {
        ...
        category: "no-metal", type: "No metal", state: "Gas", config: "1s² 2s² 2p³",
    ...
    },
    {
        ...
        category: "halogeno", type: "Halógeno", state: "Gas", config: "1s² 2s² 2p⁵",
    ...
    },
    {
        ...
        category: "gas-noble", type: "Gas Noble", state: "Gas", config: "1s² 2s² 2p⁶",
    ...
    // Periodo 3
    {
        ...
        category: "alcalino", type: "Metal Alcalino", state: "Sólido", config: "1s² 2s² 2p⁶ 3s¹",
    ...
    },
    {
        ...
        category: "alcalinoterreo", type: "Metal Alcalinotérreo", state: "Sólido", config: "1s² 2s² 2p⁶ 3s²",
    ...
    },
    {
        ...
        category: "metal-post-transicion", type: "Metal Post-transición", state: "Sólido", config: "1s² 2s² 2p⁶ 3s² 3p¹",
    ...
    },
    {
        ...
        category: "metaloide", type: "Metaloide", state: "Sólido", config: "1s² 2s² 2p⁶ 3s² 3p²",
    ...
    },
    {
        ...
        category: "no-metal", type: "No metal", state: "Sólido", config: "1s² 2s² 2p⁶ 3s² 3p³",
    ...
    },
    {
        ...
        category: "halogeno", type: "Halógeno", state: "Gas", config: "1s² 2s² 2p⁶ 3s² 3p⁵",
    ...
    },
    {
        ...
        category: "gas-noble", type: "Gas Noble", state: "Gas", config: "1s² 2s² 2p⁶ 3s² 3p⁶",
    ...
    // Periodo 4
    {
        ...
        category: "alcalino", type: "Metal Alcalino", state: "Sólido", config: "1s² 2s² 2p⁶ 3s² 3p⁶ 4s¹",
    ...
    },
    {
        ...
        category: "alcalinoterreo", type: "Metal Alcalinotérreo", state: "Sólido", config: "1s² 2s² 2p⁶ 3s² 3p⁶ 4s²",
    ...
    },
    {
        ...
        category: "metal-transicion", type: "Metal de Transición", state: "Sólido", config: "1s² 2s² 2p⁶ 3s² 3p⁶ 3d¹ 4s²",
    ...
    },
    {
        ...
        category: "metal-post-transicion", type: "Metal Post-transición", state: "Sólido", config: "1s² 2s² 2p⁶ 3s² 3p⁶ 3d¹⁰ 4s² 4p¹",
    ...
    },
    {
        ...
        category: "metaloide", type: "Metaloide", state: "Sólido", config: "1s² 2s² 2p⁶ 3s² 3p⁶ 3d¹⁰ 4s² 4p²",
    ...
    },
    {
        ...
        category: "no-metal", type: "No metal", state: "Sólido", config: "1s² 2s² 2p⁶ 3s² 3p⁶ 3d¹⁰ 4s² 4p⁴",
    ...
    },
    {
        ...
        category: "halogeno", type: "Halógeno", state: "Líquido", config: "1s² 2s² 2p⁶ 3s² 3p⁶ 3d¹⁰ 4s² 4p⁵",
    ...
    },
    {
        ...
        category: "gas-noble", type: "Gas Noble", state: "Gas", config: "1s² 2s² 2p⁶ 3s² 3p⁶ 3d¹⁰ 4s² 4p⁶",
    ...
    // Periodo 5
    {
        ...
        category: "alcalino", type: "Metal Alcalino", state: "Sólido", config: "1s² 2s² 2p⁶ 3s² 3p⁶ 3d¹⁰ 4s² 4p⁶ 5s¹",
    ...
    },
    {
        ...
        category: "alcalinoterreo", type: "Metal Alcalinotérreo", state: "Sólido", config: "1s² 2s² 2p⁶ 3s² 3p⁶ 3d¹⁰ 4s² 4p⁶ 5s²",
    ...
    },
    {
        ...
        category: "metal-transicion", type: "Metal de Transición", state: "Sólido", config: "1s² 2s² 2p⁶ 3s² 3p⁶ 3d¹⁰ 4s² 4p⁶ 4d¹ 5s²",
    ...
    },
    {
        ...
        category: "metal-transicion", type: "Metal de Transición", state: "Sólido", config: "1s² 2s² 2p⁶ 3s² 3p⁶ 3d¹⁰ 4s² 4p⁶ 4d¹⁰",
    ...
    },
    {
        ...
        category: "metal-post-transicion", type: "Metal Post-transición", state: "Sólido", config: "1s² 2s² 2p⁶ 3s² 3p⁶ 3d¹⁰ 4s² 4p⁶ 4d¹⁰ 5s² 5p¹",
    ...
    },
    {
        ...
        category: "metaloide", type: "Metaloide", state: "Sólido", config: "1s² 2s² 2p⁶ 3s² 3p⁶ 3d¹⁰ 4s² 4p⁶ 4d¹⁰ 5s² 5p³",
    ...
    },
    {
        ...
        category: "halogeno", type: "Halógeno", state: "Sólido", config: "1s² 2s² 2p⁶ 3s² 3p⁶ 3d¹⁰ 4s² 4p⁶ 4d¹⁰ 5s² 5p⁵",
    ...
    },
    {
        ...
        category: "gas-noble", type: "Gas Noble", state: "Gas", config: "1s² 2s² 2p⁶ 3s² 3p⁶ 3d¹⁰ 4s² 4p⁶ 4d¹⁰ 5s² 5p⁶",
    ...
    // Periodo 6
    {
        ...
        category: "alcalino", type: "Metal Alcalino", state: "Sólido", config: "1s² 2s² 2p⁶ 3s² 3p⁶ 3d¹⁰ 4s² 4p⁶ 4d¹⁰ 5s² 5p⁶ 6s¹",
    ...
    },
    {
        ...
        category: "alcalinoterreo", type: "Metal Alcalinotérreo", state: "Sólido", config: "1s² 2s² 2p⁶ 3s² 3p⁶ 3d¹⁰ 4s² 4p⁶ 4d¹⁰ 5s² 5p⁶ 6s²",
        image: "https://th.bing.com/th/id/OIP.C4LPtClUNKoyjII4NL5_rgHaES?w=283&h=180&c=7&r=0&o=7&dpr=1.4&pid=1.7&rm=3"
    },
    // ** INICIO PLACEHOLDER LANTÁNIDOS **
    {
        number: "57-71", symbol: "*", name: "Lantánidos", mass: "", row: 6, column: 3,
        category: "lantanido", type: "Lantánido", state: "-", config: "-", image: ""
    },
    // ** FIN PLACEHOLDER LANTÁNIDOS **
    {
        number: 72, symbol: "Hf", name: "Hafnio", mass: 178.49, row: 6, column: 4,
        category: "metal-transicion", type: "Metal de Transición", state: "Sólido", config: "1s² 2s² 2p⁶ 3s² 3p⁶ 3d¹⁰ 4s² 4p⁶ 4d¹⁰ 4f¹⁴ 5s² 5p⁶ 5d² 6s²",
    ...
    },
    {
        ...
        category: "metal-transicion", type: "Metal de Transición", state: "Líquido", config: "1s² 2s² 2p⁶ 3s² 3p⁶ 3d¹⁰ 4s² 4p⁶ 4d¹⁰ 4f¹⁴ 5s² 5p⁶ 5d¹⁰ 6s²",
    ...
    },
    {
        ...
        category: "metal-post-transicion", type: "Metal Post-transición", state: "Sólido", config: "1s² 2s² 2p⁶ 3s² 3p⁶ 3d¹⁰ 4s² 4p⁶ 4d¹⁰ 4f¹⁴ 5s² 5p⁶ 5d¹⁰ 6s² 6p¹",
    ...
    },
    {
        ...
        category: "metaloide", type: "Metaloide", state: "Sólido", config: "1s² 2s² 2p⁶ 3s² 3p⁶ 3d¹⁰ 4s² 4p⁶ 4d¹⁰ 4f¹⁴ 5s² 5p⁶ 5d¹⁰ 6s² 6p⁴",
    ...
    },
    {
        ...
        category: "halogeno", type: "Halógeno", state: "Sólido", config: "1s² 2s² 2p⁶ 3s² 3p⁶ 3d¹⁰ 4s² 4p⁶ 4d¹⁰ 4f¹⁴ 5s² 5p⁶ 5d¹⁰ 6s² 6p⁵",
    ...
    },
    {
        ...
        category: "gas-noble", type: "Gas Noble", state: "Gas", config: "1s² 2s² 2p⁶ 3s² 3p⁶ 3d¹⁰ 4s² 4p⁶ 4d¹⁰ 4f¹⁴ 5s² 5p⁶ 5d¹⁰ 6s² 6p⁶",
    ...
    // Periodo 7
    {
        ...
        category: "alcalino", type: "Metal Alcalino", state: "Sólido", config: "1s² 2s² 2p⁶ 3s² 3p⁶ 3d¹⁰ 4s² 4p⁶ 4d¹⁰ 4f¹⁴ 5s² 5p⁶ 5d¹⁰ 6s² 6p⁶ 7s¹",
    ...
    },
    {
        ...
        category: "alcalinoterreo", type: "Metal Alcalinotérreo", state: "Sólido", config: "1s² 2s² 2p⁶ 3s² 3p⁶ 3d¹⁰ 4s² 4p⁶ 4d¹⁰ 4f¹⁴ 5s² 5p⁶ 5d¹⁰ 6s² 6p⁶ 7s²",
        image: "https://tse4.mm.bing.net/th/id/OIP.T8MUWGuqHsxtvIlMf92zRAHaE8?pid=ImgDet&w=195&h=130&c=7&dpr=1.4&o=7&rm=3"
    },
    // ** INICIO PLACEHOLDER ACTÍNIDOS **
    {
        number: "89-103", symbol: "**", name: "Actínidos", mass: "", row: 7, column: 3,
        category: "actinido", type: "Actínido", state: "-", config: "-", image: ""
    },
    // ** FIN PLACEHOLDER ACTÍNIDOS **
    {
        number: 104, symbol: "Rf", name: "Rutherfordio", mass: 267, row: 7, column: 4,
        category: "metal-transicion", type: "Metal de Transición", state: "Sólido", config: "1s² 2s² 2p⁶ 3s² 3p⁶ 3d¹⁰ 4s² 4p⁶ 4d¹⁰ 4f¹⁴ 5s² 5p⁶ 5d¹⁰ 5f¹⁴ 6s² 6p⁶ 6d² 7s²",
    ...
    },
    {
        ...
        category: "metal-transicion", type: "Metal de Transición", state: "Gas", config: "1s² 2s² 2p⁶ 3s² 3p⁶ 3d¹⁰ 4s² 4p⁶ 4d¹⁰ 4f¹⁴ 5s² 5p⁶ 5d¹⁰ 5f¹⁴ 6s² 6p⁶ 6d¹⁰ 7s²",
    ...
    },
    {
        ...
        category: "metal-post-transicion", type: "Metal Post-transición", state: "Sólido", config: "1s² 2s² 2p⁶ 3s² 3p⁶ 3d¹⁰ 4s² 4p⁶ 4d¹⁰ 4f¹⁴ 5s² 5p⁶ 5d¹⁰ 5f¹⁴ 6s² 6p⁶ 6d¹⁰ 7s² 7p¹",
    ...
    },
    {
        ...
        category: "halogeno", type: "Halógeno", state: "Sólido", config: "1s² 2s² 2p⁶ 3s² 3p⁶ 3d¹⁰ 4s² 4p⁶ 4d¹⁰ 4f¹⁴ 5s² 5p⁶ 5d¹⁰ 5f¹⁴ 6s² 6p⁶ 6d¹⁰ 7s² 7p⁵",
    ...
    },
    {
        ...
        category: "gas-noble", type: "Gas Noble", state: "Gas", config: "1s² 2s² 2p⁶ 3s² 3p⁶ 3d¹⁰ 4s² 4p⁶ 4d¹⁰ 4f¹⁴ 5s² 5p⁶ 5d¹⁰ 5f¹⁴ 6s² 6p⁶ 6d¹⁰ 7s² 7p⁶",
        image: "https://www.shutterstock.com/image-vector/oganesson-atom-shell-260nw-1259753158.jpg"
    },

    // --- FILAS DE LANTÁNIDOS Y ACTÍNIDOS ---
    // (Van en las filas visuales 9 y 10, separadas de la tabla principal)
    
    // Lantánidos
    {
        number: 57, symbol: "La", name: "Lantano", mass: 138.91, row: 9, column: 3,
        category: "lantanido", type: "Lantánido", state: "Sólido", config: "1s² 2s² 2p⁶ 3s² 3p⁶ 3d¹⁰ 4s² 4p⁶ 4d¹⁰ 5s² 5p⁶ 5d¹ 6s²",
    ...
    },
    {
        ...
        category: "lantanido", type: "Lantánido", state: "Sólido", config: "1s² 2s² 2p⁶ 3s² 3p⁶ 3d¹⁰ 4s² 4p⁶ 4d¹⁰ 4f¹ 5s² 5p⁶ 5d¹ 6s²",
    ...
    },
    {
        ...
        category: "lantanido", type: "Lantánido", state: "Sólido", config: "1s² 2s² 2p⁶ 3s² 3p⁶ 3d¹⁰ 4s² 4p⁶ 4d¹⁰ 4f³ 5s² 5p⁶ 6s²",
    ...
    {
        number: 71, symbol: "Lu", name: "Lutecio", mass: 174.97, row: 9, column: 17,
        category: "lantanido", type: "Lantánido", state: "Sólido", config: "1s² 2s² 2p⁶ 3s² 3p⁶ 3d¹⁰ 4s² 4p⁶ 4d¹⁰ 4f¹⁴ 5s² 5p⁶ 5d¹ 6s²",
    ...
    // Actínidos
    {
        ...
        category: "actinido", type: "Actínido", state: "Sólido", config: "1s² 2s² 2p⁶ 3s² 3p⁶ 3d¹⁰ 4s² 4p⁶ 4d¹⁰ 4f¹⁴ 5s² 5p⁶ 5d¹⁰ 6s² 6p⁶ 6d¹ 7s²",
    ...
    },
    {
        ...
        category: "actinido", type: "Actínido", state: "Sólido", config: "1s² 2s² 2p⁶ 3s² 3p⁶ 3d¹⁰ 4s² 4p⁶ 4d¹⁰ 4f¹⁴ 5s² 5p⁶ 5d¹⁰ 5f² 6s² 6p⁶ 6d¹ 7s²",
    ...
    },
    {
        ...
        category: "actinido", type: "Actínido", state: "Sólido", config: "1s² 2s² 2p⁶ 3s² 3p⁶ 3d¹⁰ 4s² 4p⁶ 4d¹⁰ 4f¹⁴ 5s² 5p⁶ 5d¹⁰ 5f⁶ 6s² 6p⁶ 7s²",
    ...
    {
        number: 103, symbol: "Lr", name: "Lawrencio", mass: 262, row: 10, column: 17,
        category: "actinido", type: "Actínido", state: "Sólido", config: "1s² 2s² 2p⁶ 3s² 3p⁶ 3d¹⁰ 4s² 4p⁶ 4d¹⁰ 4f¹⁴ 5s² 5p⁶ 5d¹⁰ 5f¹⁴ 6s² 6p⁶ 6d¹ 7s²",
